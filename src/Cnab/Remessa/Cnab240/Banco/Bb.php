...
class Bb extends AbstractRemessa implements RemessaContract
{
    ...
    protected function segmentoP(BoletoContract $boleto)
    {
        ...
        $this->add(37, 37, '');
        $this->add(38, 57, Util::formatCnab('X', $this->getBancoEmiteNossoNumero() == 1 ? '00000000000000000000' : $this->nossoNumero($boleto), 20));
        $this->add(58, 58, '1'); //'1' = Cobrança Simples
        $this->add(59, 59, '');
        $this->add(60, 60, '');
        $this->add(61, 61, Util::formatCnab('9', !empty($this->getIdentificacaoEmissao()) ? $this->getIdentificacaoEmissao() : '', 1));
